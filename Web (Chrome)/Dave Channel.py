...
time.sleep(2)
davedropdown = driver.find_element_by_id('nav-bar-dave')
davedropdownlink = davedropdown.get_attribute('href')
print(davedropdownlink)
davedropdown.click()

# --- scroll page ---
Davetvguide = driver.find_element_by_id('tv-guide').click()
time.sleep(2)
...
Watchlivedave = driver.find_element_by_id('on-now').click()
